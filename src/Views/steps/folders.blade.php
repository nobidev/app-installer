...
@section('step')
        ...
        <div class="w-full px-4 py-2 border-b border-gray-200 text-gray-800">
            ...
            <span class="float-right">
                @if($checks['storage.framework'])
                    <svg class="w-6 h-6 text-green-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                         fill="currentColor"><path fill-rule="evenodd"
                                                   d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                                   clip-rule="evenodd"/></svg>
                @else
                    <svg class="w-6 h-6 text-red-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                         fill="currentColor"><path fill-rule="evenodd"
    ...
    <div class="flex justify-end">
        @if(!in_array(false, $checks, true))
            <a href="{{ route('AppInstaller::install.database') }}"
        ...
        @else
            <a href="{{ route('AppInstaller::install.folders') }}"
