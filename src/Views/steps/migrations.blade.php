...
@section('step')
    ...
    @endif
    <p class="pb-3 text-gray-800">The installation of the database and the loading of all the basic data of the
        application will be carried out.</p>
    <p class="pb-3 text-gray-800">This may take a while, please wait and don't close the page.</p>
    <form method="post" action="{{ route('AppInstaller::install.runMigrations') }}">
        @csrf
